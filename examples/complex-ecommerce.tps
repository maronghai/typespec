...
;   - FK abbreviations: C=CASCADE, R=RESTRICT, SN=SET NULL
...
-> brand_id brand.id [SN]
-> category_id category.id [SN]
...
-> order_id order.id [C]
-> product_id product.id [NA]
-> sku_id product_sku.id [SN]
